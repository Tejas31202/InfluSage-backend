...
routes.post("/contract/approve-reject",
    authenticateUser(["Influencer"]),
    influencerApproveOrRejectContract);

routes.post("/upload/content-link",
    authenticateUser(["Influencer"]),
    uploadContentLink);

routes.get("/contract-detail/:p_campaignid",
    authenticateUser(["Influencer"]),
    getInfluencerContractDetail);

routes.get("/content-links/:p_campaignid",
    authenticateUser(["Influencer"]),
    getInfluencerUploadedContentLink);

routes.get("/contracts/:p_contractid/content-types",
    authenticateUser(["Influencer"]),
    getContractContentTypes);
