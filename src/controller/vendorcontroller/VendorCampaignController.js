   ...
   await redisClient.set(redisKey, draftData);
    ...
    const result = await client.query(
      ...
      [
        ...
        campaignId,
        p_statusname,
        draftData.p_objectivejson||null ,
        draftData.p_vendorinfojson||null ,
        req.body.p_campaignjson,
        draftData.p_campaigncategoyjson||null,
        draftData.p_campaignfilejson||null,
        draftData.p_contenttypejson||null,
        null,
        null,
        null
      ]
