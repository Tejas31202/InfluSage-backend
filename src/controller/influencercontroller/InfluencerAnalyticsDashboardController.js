...
export const getInfluencerCampaignPerformanceOvertime = async (req, res) => {
    ...
    try {
        ...
        const campaignOvertimeRes = performanceOvertime.rows[0].fn_get_influencercampaignperformanceovertime[0];

        console.log("campaignperformaceovertime", campaignOvertimeRes);
...
export const getInfluencerCampaignEngagementScore = async (req, res) => {
    ...
    try {
        ...
        console.log("Campaign Engagement Score=>", campaignEngagementScoreRes);
...
export const getInfluencerCampaignTopPerformingContent = async (req, res) => {
    ...
    try {
        ...
        const campaignTopPerformingContentRes = campaignTopPerformingContent.rows[0].fn_get_influencercampaigntopperformingcontent[0];

        console.log("Top Performing Campaign Content =>", campaignTopPerformingContentRes);
